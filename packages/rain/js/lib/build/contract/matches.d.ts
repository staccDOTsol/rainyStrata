...
export declare class MatchesInstruction {
    ...
    joinMatch(kp: Keypair, args: JoinMatchArgs, accounts: JoinMatchAccounts, additionalArgs: JoinMatchAdditionalArgs): Promise<{
        instructions: web3.TransactionInstruction[];
...
export declare class MatchesProgram {
    ...
    joinMatch(kp: Keypair, args: JoinMatchArgs, accounts: JoinMatchAccounts, additionalArgs: JoinMatchAdditionalArgs): Promise<void>;
