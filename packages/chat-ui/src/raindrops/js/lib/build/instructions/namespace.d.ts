...
export declare class Instruction extends SolKitInstruction {
    ...
    initializeNamespace(args: InitializeNamespaceArgs, accounts: InitializeNamespaceAccounts): Promise<any[]>;
    updateNamespace(args: UpdateNamespaceArgs, accounts: UpdateNamespaceAccounts): Promise<any[]>;
}
