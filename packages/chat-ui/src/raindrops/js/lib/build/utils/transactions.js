...
export const sendTransactionWithRetryWithKeypair = (connection, wallet, instructions, signers, commitment = "singleGossip", includesFeePayer = false, block, beforeSend) => __awaiter(void 0, void 0, void 0, function* () {
...
export function sendTransactionWithRetry(connection, wallet, instructions, signers, commitment = "singleGossip") {
...
export function sendSignedTransaction({ signedTransaction, connection, timeout = DEFAULT_TIMEOUT, }) {
    return __awaiter(this, void 0, void 0, function* () {
...
function simulateTransaction(connection, transaction, commitment) {
    return __awaiter(this, void 0, void 0, function* () {
        transaction.recentBlockhash = yield connection.getLatestBlockhash();
