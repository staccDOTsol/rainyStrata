...
export declare class MatchesInstruction {
    ...
    updateMatchFromOracle(kp: web3.Keypair, args: {} | undefined, accounts: UpdateMatchFromOracleAccounts, _additionalArgs?: {}): Promise<{
        instructions: web3.TransactionInstruction[];
        signers: never[];
    }>;
...
export declare class MatchesProgram {
    ...
    createMatch(kp: web3.Keypair, args: CreateMatchArgs, _accounts: {} | undefined, additionalArgs: CreateMatchAdditionalArgs): Promise<void>;
    ...
    updateMatchFromOracle(kp: web3.Keypair, args: {} | undefined, accounts: UpdateMatchFromOracleAccounts, _additionalArgs?: {}): Promise<void>;
