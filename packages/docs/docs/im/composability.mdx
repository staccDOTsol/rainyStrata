...
speed2earn.games is built for composability. As we saw in [Getting Started](./getting_started),
you can easily create token gated chatrooms and embed them anywhere.

speed2earn.games goes one step further. Because a chatroom is just transaction history
